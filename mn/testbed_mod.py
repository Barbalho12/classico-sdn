...
def topology():
    ...
    net.addLink(h6, s14, bw=_bw, use_htb=_use_htb)
    net.addLink(h7, s17, bw=_bw, use_htb=_use_htb)
    net.addLink(h8, s02, bw=_bw, use_htb=_use_htb)
    net.addLink(h9, s15, bw=_bw, use_htb=_use_htb)
