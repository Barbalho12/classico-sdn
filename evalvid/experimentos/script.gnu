...
plot 	'out_ssim.txt' 	using ($1/24):3 t 'Multicast' with linespoints lw 1 pt 7 ps 2 lc rgb '#0060ad' 
...
plot 	'out_vqm.txt' 	using ($1/24):3 t 'Multicast' with linespoints lw 1 pt 7 ps 2 lc rgb '#0060ad' 
